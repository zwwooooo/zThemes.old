...
<!-- You can start editing here. -->
	<?php if ( have_comments() ) : ?>
			<div id="comments-div"><h2 id="comments"><?php comments_number('0', '1', '%' );?> Comments.</h2><span id="comments-addcomment"><a href="#respond"  rel="nofollow" title="Leave a comment ?">Leave a comment</a></span></div>
			<ol class="commentlist" id="thecomments">
					<?php wp_list_comments('type=comment&callback=mytheme_comment'); ?>
			</ol>
<?php if ((int) get_option('page_comments') === 1 && get_comment_pages_count() > 1) { ?>
			<div class="navigation"><span><?php paginate_comments_links(); ?></span></div>
<?php } ?>
